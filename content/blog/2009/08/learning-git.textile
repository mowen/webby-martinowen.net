...
filter: textile
---
I've been using Git on home projects since about January, so here are some of my thoughts.

h3. Why should I use Git?

h4. GitHub

GitHub was my primary motivation for getting to know Git. It's an amazing piece of work - like a wonderful blend of Sourceforge and Twitter. When you compare it to Microsoft's open source project hosting effort "CodePlex":http://www.codeplex.com/, you can see just how much they are playing catch-up in this area.
...
The way the site (and Git itself) is designed encourages collaboration on projects. "Here's a funny example":http://github.com/rails/rails/commit/22af62cf486721ee2e45bb720c42ac2f4121faf4 of people arguing over a Ruby on Rails commit.
...
Scott Chacon's "Git Internals PDF":http://peepcode.com/products/git-internals-pdf at Peepcode helped me a great deal in understanding the file system.
